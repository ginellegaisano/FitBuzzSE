...
/**
 * An activity representing a single sleepChooser detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link sleepChooserListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link sleepChooserDetailFragment}.
 */
public class sleepChooserDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(sleepChooserDetailFragment.ARG_ITEM_ID,
